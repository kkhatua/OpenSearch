...
public class TableSummarizerTests extends OpenSearchTestCase {
    ...
    // ---------- summarize returns original table when no summarize param ----------

    public void testNoSummarizeParamReturnsOriginal() {
        Table t = buildNumericTable();
        assertSame(t, TableSummarizer.summarize(t, null, "index,sum(docs)"));
        assertSame(t, TableSummarizer.summarize(t, "", "index,sum(docs)"));
    }
    ...
    public void testSummarizeSum() {
        Table t = buildNumericTable();
        Table result = TableSummarizer.summarize(t, "index", "index,sum(docs),sum(size)");
    ...
    public void testSummarizeCount() {
        Table t = buildNumericTable();
        Table result = TableSummarizer.summarize(t, "index", "index,count(shard)");
    ...
    public void testSummarizeAvg() {
        Table t = buildNumericTable();
        Table result = TableSummarizer.summarize(t, "index", "index,avg(docs)");
    ...
    public void testSummarizeMinMax() {
        Table t = buildNumericTable();
        Table result = TableSummarizer.summarize(t, "index", "index,min(docs),max(docs)");
    ...
    public void testSummarizeMultipleGroupByFields() {
        Table t = buildNumericTable();
        Table result = TableSummarizer.summarize(t, "index,shard", "index,shard,sum(docs)");
        assertThat(result.getRows().size(), equalTo(3));
    }

    public void testSummarizeNoAggFunctions() {
        Table t = buildNumericTable();
        Table result = TableSummarizer.summarize(t, "index", "index");
        // Should still group — 2 distinct indices
        assertThat(result.getRows().size(), equalTo(2));
    }
    ...
    public void testSummarizerDoesNotTruncateGroups() {
        ...
        Table result = TableSummarizer.summarize(t, "index", "index,sum(docs)");
        assertThat(result.getRows().size(), equalTo(2));
    }
    ...
    public void testSummarizePreservesByteSizeValue() {
        Table t = buildNumericTable();
        Table result = TableSummarizer.summarize(t, "index", "index,sum(size),avg(size)");
    ...
    public void testSummarizeTimeValuePreservation() {
        ...
        Table result = TableSummarizer.summarize(t, "group", "group,sum(duration),avg(duration),min(duration),max(duration)");
    ...
    public void testSummarizeTimeValueHumanReadable() {
        Table t = buildTimeTable();
        Table result = TableSummarizer.summarize(t, "group", "group,sum(duration),min(duration),max(duration)");
    ...
    public void testSummarizeByteSizeValueHumanReadable() {
        Table t = buildNumericTable();
        Table result = TableSummarizer.summarize(t, "index", "index,sum(size),min(size),max(size)");
    ...
    public void testSummarizeByteSizeValueWithExplicitUnit() {
        Table t = buildNumericTable();
        Table result = TableSummarizer.summarize(t, "index", "index,sum(size)");
    ...
    public void testIntegerShortByteRoundTrip() {
        ...
        Table result = TableSummarizer.summarize(t, "g", "g,sum(vi),sum(vs),sum(vb)");
    ...
    public void testSizeValueRoundTrip() {
        ...
        Table result = TableSummarizer.summarize(t, "g", "g,sum(count_v)");
    ...
    public void testStringNumericRoundTrip() {
        ...
        Table result = TableSummarizer.summarize(t, "g", "g,sum(vstr)");
    ...
    public void testAvgIgnoresNullValuesInDenominator() {
        ...
        Table result = TableSummarizer.summarize(t, "g", "g,avg(v),count(v)");
    ...
    public void testAvgIsNullWhenAllValuesAreNull() {
        ...
        Table result = TableSummarizer.summarize(t, "g", "g,avg(v),count(v),sum(v)");
    ...
    public void testGroupKeyDoesNotCollideOnNulCharInValue() {
        ...
        Table result = TableSummarizer.summarize(t, "a,b", "a,b,sum(v)");

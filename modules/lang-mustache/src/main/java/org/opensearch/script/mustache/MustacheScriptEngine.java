...
public final class MustacheScriptEngine implements ScriptEngine {
     ...
     * that a dynamic {@code script.mustache.runtime_enabled} update takes effect immediately, including for templates
     * that were compiled and cached while the feature was enabled.
     */
